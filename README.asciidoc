== dbunit-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The dbunit-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>com.github.database.rider.addon</groupId>
   <artifactId>dbunit-addon</artifactId>
